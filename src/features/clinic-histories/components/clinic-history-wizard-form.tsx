...
export function ClinicHistoryWizardForm({
  ...
  const formFields = (
    <div className="space-y-6 font-montserrat min-h-[400px]">
      {/* STEP INDICATOR */}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  onClick={() => appendTreatment({ clinical_treatment_id: "", supply_id: null, quantity: 0.1, is_recurring: false })}
      ...
      <Drawer open={open} onOpenChange={onOpenChange}>
        <DrawerContent className="font-montserrat">
          <DrawerHeader className="text-left">
            <DrawerTitle>{isEdit ? "Editar Consulta Médica" : "Nueva Consulta Médica"}</DrawerTitle>
            <DrawerDescription>
              Complete el diagnóstico e indicaciones veterinarias.
            </DrawerDescription>
          </DrawerHeader>
          <div className="px-4 overflow-y-auto max-h-[70vh]">
            <form id="mobile-wizard-form" onSubmit={handleSubmit(handleFormSubmit as any)}>
              {formFields}
            </form>
          </div>
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl font-montserrat max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{isEdit ? "Editar Consulta Médica" : "Nueva Consulta Médica"}</DialogTitle>
          <DialogDescription>
            Agregue diagnósticos, tratamientos y configure las dosis programadas de forma unificada.
          </DialogDescription>
        </DialogHeader>
